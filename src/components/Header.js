  ...
  const handlePostJob = () => {
    ...
    return (
        ...
        <div className="header-menu">
          ...
          <Link to={`${isEmployer ? '/employer-home-page/my-jobs' : '/employee-home-page/about'}`}>About</Link>
          <Link to={`${isEmployer ? '/employer-home-page/my-jobs' : '/employee-home-page/contact'}`}>Contact Us</Link>
          <Link to={`${isEmployer ? '/employer-home-page/my-jobs' : '/employee-home-page/blog'}`}>Blog</Link>
        </div>
